...
import id.sch.smktelkom_mlg.privateassignment.xirpl331.the_movie_database.Activity.MainActivity;
import id.sch.smktelkom_mlg.privateassignment.xirpl331.the_movie_database.R;
import id.sch.smktelkom_mlg.privateassignment.xirpl331.the_movie_database.Utils.SaveFavorites;
import id.sch.smktelkom_mlg.privateassignment.xirpl331.the_movie_database.Utils.TinyUrls;
...
//    @BindView(R.id.trailer1) Button trailer_button2;
    ...
    TextView reviews;
    @BindView(R.id.trailer1Detail)
    TextView trailer1Detail;
    @BindView(R.id.trailer2Detail)
    TextView trailer2Detail;
    @BindView(R.id.trailerImage1)
    ImageView trailerImage1;
    @BindView(R.id.trailerImage2)
